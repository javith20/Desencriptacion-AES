...
public class main {
	...
	public static Combination find_son(Combination _father,int trys) {
		...
		Combination first_subgroup = _father.create_new_combination(0.5);
		Combination second_subgroup = _father.create_new_combination(0.5);
		first_subgroup.try_combinations(0.30);
		second_subgroup.try_combinations(0.30);
